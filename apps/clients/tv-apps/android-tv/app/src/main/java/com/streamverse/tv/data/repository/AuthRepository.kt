...
import com.streamverse.tv.data.api.AuthApiService
...
class AuthRepository(
    ...
    private fun saveAuthData(response: AuthResponse) {
        ...
        // Also save to DRMHelper for DRM requests
        response.accessToken.let {
            com.streamverse.tv.ui.player.drm.DRMHelper.saveAuthToken(context, it)
        }
    }
    ...
    private fun clearAuthData() {
        ...
        com.streamverse.tv.ui.player.drm.DRMHelper.clearAuthToken(context)
    }
}
